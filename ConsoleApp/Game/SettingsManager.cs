...
namespace ConsoleApp {
    ...
    public class SettingsManager {
        ...
        private void SaveUserSettings(Settings settings) {
            ...
            string path = $"{Data.Path}user_settings.json";
            StreamWriter fileUserSettings = new StreamWriter(path);
            string jsonString = JsonSerializer.Serialize(settings, Data.JsonOptions);
        ...
        public void LoadSettings() {
            ...
            string pathDefaultSettings = $"{Data.Path}default_settings.json";
            ...
            // load user settings
            string pathUserSettings = $"{Data.Path}user_settings.json"; 
        ...
        public void ResetSettingsToDefault() {
            ...
            StreamWriter fileUserSettings = new StreamWriter(path);
            string jsonString = JsonSerializer.Serialize(DefaultSettings, Data.JsonOptions);
